  ...
  return (
    <section className='p-8 flex w-full items-center justify-evenly flex-col gap-8 my-14' id='faq'>
      ...
      <AccordionList className='w-full gap-8 p-0 sm:p-8 grid sm:grid-cols-2'>
        ...
        <Details header='¿Cada cuánto se actualiza la información?'>
        ...
        <Details header='¿Puedo usar los datos en mi página web?'>
          Sí. Siempre y cuando nos cites como fuente. puedes utilizar este endpoint <a className='text-cyan-400 visited:text-cyan-600' href='/api/interruptions' target='_blank' rel='noopener noreferrer'>/api/interruptions</a>
        </Details>
